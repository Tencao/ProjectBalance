...
object ObjRegistry
{
    ...
    fun registerItems(evt: RegistryEvent.Register<Item>) {
        ...
        registerObj<Item>(r, repairTalisman, repairTalisman.translationKey)
        setNewValue("repairTalisman", repairTalisman)
        registerObj<Item>(r, kleinStars, kleinStars.translationKey)
        setNewValue("kleinStars", kleinStars)
        registerObj<Item>(r, matter, matter.translationKey)
        setNewValue("matter", matter)

        registerObj<Item>(r, dmPick, dmPick.translationKey)
        setNewValue("dmPick", dmPick)
        registerObj<Item>(r, dmAxe, dmAxe.translationKey)
        setNewValue("dmAxe", dmAxe)
        registerObj<Item>(r, dmShovel, dmShovel.translationKey)
        setNewValue("dmShovel", dmShovel)
        registerObj<Item>(r, dmSword, dmSword.translationKey)
        setNewValue("dmSword", dmSword)
        registerObj<Item>(r, dmHoe, dmHoe.translationKey)
        setNewValue("dmHoe", dmHoe)
        registerObj<Item>(r, dmShears, dmShears.translationKey)
        setNewValue("dmShears", dmShears)
        registerObj<Item>(r, dmHammer, dmHammer.translationKey)
        setNewValue("dmHammer", dmHammer)
        registerObj<Item>(r, rmPick, rmPick.translationKey)
        setNewValue("rmPick", rmPick)
        registerObj<Item>(r, rmAxe, rmAxe.translationKey)
        setNewValue("rmAxe", rmAxe)
        registerObj<Item>(r, rmShovel, rmShovel.translationKey)
        setNewValue("rmShovel", rmShovel)
        registerObj<Item>(r, rmSword, rmSword.translationKey)
        setNewValue("rmSword", rmSword)
        registerObj<Item>(r, rmHoe, rmHoe.translationKey)
        setNewValue("rmHoe", rmHoe)
        registerObj<Item>(r, rmShears, rmShears.translationKey)
        setNewValue("rmShears", rmShears)
        registerObj<Item>(r, rmHammer, rmHammer.translationKey)
        setNewValue("rmHammer", rmHammer)
        registerObj<Item>(r, rmKatar, rmKatar.translationKey)
        setNewValue("rmKatar", rmKatar)
        registerObj<Item>(r, rmStar, rmStar.translationKey)
        setNewValue("rmStar", rmStar)

        registerObj<Item>(r, dmHelmet, dmHelmet.translationKey)
        setNewValue("dmHelmet", dmHelmet)
        registerObj<Item>(r, dmChest, dmChest.translationKey)
        setNewValue("dmChest", dmChest)
        registerObj<Item>(r, dmLegs, dmLegs.translationKey)
        setNewValue("dmLegs", dmLegs)
        registerObj<Item>(r, dmFeet, dmFeet.translationKey)
        setNewValue("dmFeet", dmFeet)

        registerObj<Item>(r, rmHelmet, rmHelmet.translationKey)
        setNewValue("rmHelmet", rmHelmet)
        registerObj<Item>(r, rmChest, rmChest.translationKey)
        setNewValue("rmChest", rmChest)
        registerObj<Item>(r, rmLegs, rmLegs.translationKey)
        setNewValue("rmLegs", rmLegs)
        registerObj<Item>(r, rmFeet, rmFeet.translationKey)
        setNewValue("rmFeet", rmFeet)

        registerObj<Item>(r, gemHelmet, gemHelmet.translationKey)
        setNewValue("gemHelmet", gemHelmet)
        registerObj<Item>(r, gemChest, gemChest.translationKey)
        setNewValue("gemChest", gemChest)
        registerObj<Item>(r, gemLegs, gemLegs.translationKey)
        setNewValue("gemLegs", gemLegs)
        registerObj<Item>(r, gemFeet, gemFeet.translationKey)
        setNewValue("gemFeet", gemFeet)

        registerObj<Item>(r, angelSmite, angelSmite.translationKey)
        setNewValue("angelSmite", angelSmite)
        registerObj<Item>(r, harvestGod, harvestGod.translationKey)
        setNewValue("harvestGod", harvestGod)
        registerObj<Item>(r, ignition, ignition.translationKey)
        setNewValue("ignition", ignition)
        registerObj<Item>(r, zero, zero.translationKey)
        setNewValue("zero", zero)
        registerObj<Item>(r, swrg, swrg.translationKey)
        setNewValue("swrg", swrg)
        registerObj<Item>(r, timeWatch, timeWatch.translationKey)
        setNewValue("timeWatch", timeWatch)
        registerObj<Item>(r, arcana, arcana.translationKey)
        setNewValue("arcana", arcana)

        registerObj<Item>(r, bodyStone, bodyStone.translationKey)
        setNewValue("bodyStone", bodyStone)
        registerObj<Item>(r, soulStone, soulStone.translationKey)
        setNewValue("soulStone", soulStone)
        registerObj<Item>(r, lifeStone, lifeStone.translationKey)
        setNewValue("lifeStone", lifeStone)

        registerObj<Item>(r, everTide, everTide.translationKey)
        setNewValue("everTide", everTide)
        registerObj<Item>(r, volcanite, volcanite.translationKey)
        setNewValue("volcanite", volcanite)

        registerObj<Item>(r, tome, tome.translationKey)
        setNewValue("tome", tome)

        registerObj<Item>(r, dRod1, dRod1.translationKey)
        setNewValue("dRod1", dRod1)
        registerObj<Item>(r, dRod2, dRod2.translationKey)
        setNewValue("dRod2", dRod2)
        registerObj<Item>(r, dRod3, dRod3.translationKey)
        setNewValue("dRod3", dRod3)

        registerObj<Item>(r, transmutationTablet, transmutationTablet.translationKey)
