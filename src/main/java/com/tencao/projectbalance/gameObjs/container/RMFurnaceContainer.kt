...
import moze_intel.projecte.gameObjs.container.slots.SlotPredicates.SMELTABLE
...
class RMFurnaceContainer(invPlayer: InventoryPlayer, val tile: RMFurnaceTile) : Container() {
    ...
    init {
        ...
        //Input(0)
        this.addSlotToContainer(ValidatedSlot(input, 0, 65, 17, SMELTABLE))
