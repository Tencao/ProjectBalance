...
import com.tencao.projectbalance.gameObjs.container.CondenserContainer
...
class GUICondenser(invPlayer: InventoryPlayer, tile: CondenserTile) : GuiContainer(CondenserContainer(invPlayer, tile)) {
