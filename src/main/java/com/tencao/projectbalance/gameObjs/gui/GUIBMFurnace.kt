...
import com.tencao.projectbalance.gameObjs.container.BMFurnaceContainer
...
class GUIBMFurnace(invPlayer: InventoryPlayer, val tile: BMFurnaceTile) : GuiContainer(BMFurnaceContainer(invPlayer, tile)) {
    ...
    override fun drawGuiContainerForegroundLayer(var1: Int, var2: Int) {
        this.fontRenderer.drawString(I18n.format("pe.bmfurnace.shortname"), 76, 5, 4210752)
