...
import com.tencao.projectbalance.gameObjs.container.CondensedRelayMK2Container
...
class GUICondensedRelayMK2(invPlayer: InventoryPlayer, private val tile: CondensedRelayMK2Tile) : GuiContainer(CondensedRelayMK2Container(invPlayer, tile)) {
    private val container: CondensedRelayMK2Container

    init {
        this.xSize = 193
        this.ySize = 182
        this.container = inventorySlots as CondensedRelayMK2Container
    }
    ...
    override fun drawGuiContainerBackgroundLayer(var1: Float, var2: Int, var3: Int) {
        ...
        this.drawTexturedModalRect(x + 81, y + 68, 0, 183, progress, 10)
