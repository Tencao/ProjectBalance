...
import com.tencao.projectbalance.gameObjs.container.CondensedRelayMK3Container
...
class GUICondensedRelayMK3(invPlayer: InventoryPlayer, private val tile: CondensedRelayMK3Tile) : GuiContainer(CondensedRelayMK3Container(invPlayer, tile)) {
    private val container: CondensedRelayMK3Container

    init {
        this.xSize = 212
        this.ySize = 194
        this.container = inventorySlots as CondensedRelayMK3Container
    }
