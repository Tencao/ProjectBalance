...
import com.tencao.projectbalance.gameObjs.container.CollectorMK4Container
...
class GUICollectorMK4(invPlayer: InventoryPlayer, private val tile: CollectorMK4Tile) : GuiContainer(CollectorMK4Container(invPlayer, tile)) {
    private val container: CollectorMK4Container = inventorySlots as CollectorMK4Container
    ...
    override fun drawGuiContainerBackgroundLayer(var1: Float, var2: Int, var3: Int) {
        ...
        progress = container.kleinChargeProgress.toInt() * 48
