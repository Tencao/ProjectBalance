...
class GUIPowerFlowerMK4(invPlayer: InventoryPlayer, tile: PowerFlowerMK4Tile) : GuiContainer(PowerFlowerMK2Container(invPlayer, tile)) {
    ...
    override fun drawGuiContainerBackgroundLayer(var1: Float, var2: Int, var3: Int) {
        ...
        this.drawTexturedModalRect(x + 200, y + 20 - progress, 177, 13 - progress, 12, progress)
    }
    ...
    override fun drawGuiContainerForegroundLayer(var1: Int, var2: Int) {
        ...
        this.fontRenderer.drawString("x${container.tomes}", 233, 10, 4210752)
