...
import com.tencao.projectbalance.gameObjs.container.RelayMK3Container
...
class GUIRelayMK3(invPlayer: InventoryPlayer, private val tile: RelayMK3Tile) : GuiContainer(RelayMK3Container(invPlayer, tile)) {
    private val container: RelayMK3Container

    init {
        this.xSize = 212
        this.ySize = 194
        this.container = inventorySlots as RelayMK3Container
    }
    ...
    override fun drawGuiContainerForegroundLayer(var1: Int, var2: Int) {
        ...
        this.fontRenderer.drawString(Constants.EMC_FORMATTER.format(container.emc.toLong()), 125, 39, 4210752)
    }
